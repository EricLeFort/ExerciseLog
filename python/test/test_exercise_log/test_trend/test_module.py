...
def _gen_random_weight_training_data(num_entries: int):
    data = _init_dataframe(num_entries)
...
class TestExerciseSummary(unittest.TestCase):
    ...
    def test_foot_cardio_summary_pretty_print__include_all(self):
        _test_four_scenarios(self, _gen_random_foot_cardio_data, _assert_foot_cardio_summary)

    def test_weight_training_summary_pretty_print(self):
